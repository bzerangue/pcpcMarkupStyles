    ...
    <div id='pageWrap'>
      ...
      <div id='contentWrap'>
        <section class='main-section' role='main'>
          <div class='inner'>
            <!-- Off Canvas: Page Menu Toggle -->
            <span id='sidebarToggle'>
              <a href='#sidebar' id='sidebarButton'></a>
            </span>
            ...
            <article class='video-article'>
              <div class='video'>
                <iframe allowFullScreen='' frameborder='0' height='281' mozallowfullscreen='' src='http://player.vimeo.com/video/45947083?title=0&amp;amp;byline=0&amp;amp;portrait=0' webkitAllowFullScreen='' width='500'></iframe>
              </div>
              <header class='title'>
                <h2>Outreach &amp; Help</h2>
                <p class='lead'>Vestibulum pellentesque vulputate tempus. Suspendisse sed consequat lectus. Nulla bibendum venenatis eros, elementum malesuada mi imperdiet eu.</p>
              </header>
              <section class='body'>
